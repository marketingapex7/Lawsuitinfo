...
<p>${s.name} law still matters: the state's filing deadline, damages rules, and procedural law can shape an individual claim even when the case is litigated in the MDL.</p>`,
    ...
    process: (s, lim) =>
      `<p>Most ${s.name} GLP-1 cases are filed in or transferred to MDL-3094 in the Eastern District of Pennsylvania for coordinated discovery and bellwether trials (the first trials are scheduled to begin September 2026). ${s.name}'s general personal injury limitations period is ${lim.piYears} years (${lim.citation}), but accrual and discovery-rule questions are fact-specific for injuries that develop during ongoing medication use.</p>`,
    faqs: (s, lim) => [
      ...
      ["Has there been an Ozempic settlement?", "No. As of June 2026 no settlement program exists in the GLP-1 litigation. The first bellwether trials, scheduled for September 2026, are expected to shape settlement posture. No outcome is guaranteed."],
...
<p><strong>The CLJA filing window closed on August 10, 2024.</strong> This page is for ${s.name} residents whose claims were filed in time: roughly 407,000 administrative claims and 3,744 lawsuits remain in process, with about $800 million in settlements approved and more than $570 million paid through spring 2026.</p>`,
    eligibilityBullets: (s) => [
    ...
    faqs: (s) => [
      ...
      ["How much are Camp Lejeune settlements paying?", "Elective Option offers are tiered at roughly $100,000 to $450,000 by diagnosis and exposure duration, plus $100,000 for qualifying wrongful-death claims. Through spring 2026, about $800 million was approved and more than $570 million paid. Individual amounts vary."],
      ...
      ["Does a settlement affect VA benefits?", "CLJA awards are offset by certain VA payments already made for the same condition, but accepting a settlement does not end VA health care or disability status. The offset calculation is claim-specific."],
