...
faqs:
  ...
  -
    ...
    answer: "Georgia enacted SB 144, effective July 1, 2025, limiting pesticide failure-to-warn liability to what the EPA label requires. It can affect how Georgia claims are evaluated, so confirm the current legal posture with a lawyer."
  -
...
<p>Georgia law in this area is shifting. Governor Brian Kemp signed SB 144 (Act 94) in May 2025, with the pesticide failure-to-warn provisions taking effect July 1, 2025; the law generally limits manufacturer failure-to-warn liability to what an EPA-approved label requires, with an exception for manufacturers who knowingly withhold or misrepresent material information. Separately, the federal Eleventh Circuit (which covers Georgia) held in <em>Carson v. Monsanto</em>, 92 F.4th 980 (11th Cir. 2024), that FIFRA does not expressly or impliedly preempt a Georgia plaintiff's failure-to-warn claim &mdash; creating a circuit split that helped send the preemption question to the U.S. Supreme Court.</p>
